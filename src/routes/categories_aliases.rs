...
use crate::{error::AppError, repos::category_alias::{CategoryAlias, CategoryAliasRepo, CreateCategoryAliasPayload, UpdateCategoryAliasPayload}, types::AppState};
...
#[utoipa::path(get, path = "/categories-aliases", responses((status = 200, body = [CategoryAlias])), tag = "Category Aliases", operation_id = "listCategoryAliases")]
...
#[utoipa::path(get, path = "/categories-aliases/{alias_uid}", params(("alias_uid" = Uuid, Path)), responses((status = 200, body = CategoryAlias)), tag = "Category Aliases", operation_id = "getCategoryAlias")]
...
#[utoipa::path(post, path = "/categories-aliases", request_body = CreatePayload, responses((status = 200, body = CategoryAlias)), tag = "Category Aliases", operation_id = "createCategoryAlias")]
...
#[utoipa::path(put, path = "/categories-aliases/{alias_uid}", params(("alias_uid" = Uuid, Path)), request_body = UpdatePayload, responses((status = 200, body = CategoryAlias)), tag = "Category Aliases", operation_id = "updateCategoryAlias")]
...
#[utoipa::path(delete, path = "/categories-aliases/{alias_uid}", params(("alias_uid" = Uuid, Path)), responses((status = 200, description = "Deleted")), tag = "Category Aliases", operation_id = "deleteCategoryAlias")]
