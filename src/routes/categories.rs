...
use crate::{error::app::AppError, repos::category::{Category, CategoryRepo, CreateCategoryPayload, UpdateCategoryPayload}, types::AppState};
...
pub struct CreatePayload { pub group_uid: Uuid, pub name: String, pub description: Option<String> }
...
#[derive(Deserialize, ToSchema)]
pub struct UpdatePayload { pub name: Option<String>, pub description: Option<String> }
