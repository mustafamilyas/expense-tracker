...
use crate::{error::AppError, repos::expense_group_member::{GroupMember, GroupMemberRepo, CreateGroupMemberPayload, UpdateGroupMemberPayload}, types::AppState};
...
#[utoipa::path(get, path = "/group-members", responses((status = 200, body = [GroupMember])), tag = "Group Members", operation_id = "listGroupMembers")]
...
#[utoipa::path(get, path = "/group-members/{id}", params(("id" = Uuid, Path)), responses((status = 200, body = GroupMember)), tag = "Group Members", operation_id = "getGroupMember")]
...
#[utoipa::path(post, path = "/group-members", request_body = CreatePayload, responses((status = 200, body = GroupMember)), tag = "Group Members", operation_id = "createGroupMember")]
...
#[utoipa::path(put, path = "/group-members/{id}", params(("id" = Uuid, Path)), request_body = UpdatePayload, responses((status = 200, body = GroupMember)), tag = "Group Members", operation_id = "updateGroupMember")]
...
#[utoipa::path(delete, path = "/group-members/{id}", params(("id" = Uuid, Path)), responses((status = 200, description = "Deleted")), tag = "Group Members", operation_id = "deleteGroupMember")]
