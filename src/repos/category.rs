...
impl CategoryRepo {
    pub async fn list(tx: &mut sqlx::Transaction<'_, sqlx::Postgres>) -> Result<Vec<Category>, DatabaseError> {
    ...
    pub async fn get(tx: &mut sqlx::Transaction<'_, sqlx::Postgres>, uid: Uuid) -> Result<Category, DatabaseError> {
    ...
    pub async fn create(tx: &mut sqlx::Transaction<'_, sqlx::Postgres>, payload: CreateCategoryPayload) -> Result<Category, DatabaseError> {
        let uid = Uuid::new_v4();
        let row = sqlx::query_as::<_, Category>(
    ...
    pub async fn update(tx: &mut sqlx::Transaction<'_, sqlx::Postgres>, uid: Uuid, payload: UpdateCategoryPayload) -> Result<Category, DatabaseError> {
